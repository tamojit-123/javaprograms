...
public class EmployeeTestInteractive {
    ...
    public static boolean executeMenu(BufferedReader in, EmployeeDAO dao) throws IOException, DAOException {
        ...
        switch (action.toUpperCase().charAt(0)) {
            ...
            case 'C':
                ...
                dao.add(emp);
                System.out.println("Successfully added model.Employee Record: " + emp.getId());
                System.out.println("\n\nCreated " + emp);
                break;
            ...
            case 'R':
                ...
                // Find this model.Employee record
                emp = dao.findById(id);
                if (emp != null) {
                    System.out.println(emp + "\n");
                } else {
                    System.out.println("\n\nmodel.Employee " + id + " not found");
                    break;
                }
            ...
            case 'U':
                ...
                dao.update(emp);
                System.out.println("Successfully updated model.Employee Record: " + emp.getId());
                break;
            ...
            case 'D':
                ...
                // Find this model.Employee record
                dao.delete(id);
                System.out.println("Deleted model.Employee " + id);
                break;
    ...
    public static Employee inputEmployee(BufferedReader in, Employee empDefaults, boolean newEmployee) throws IOException {
        ...
        if (newEmployee) {
            ...
            System.out.println("Modify the fields of model.Employee record: " + id
        ...
        // Create an model.Employee object
