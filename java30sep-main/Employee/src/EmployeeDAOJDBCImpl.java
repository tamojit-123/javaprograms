...
public class EmployeeDAOJDBCImpl implements EmployeeDAO {
    ...
    // Add an model.Employee record using an INSERT SQL command
    ...
    public void delete(int id) throws DAOException {
        ...
        if (emp == null) {
            throw new DAOException("model.Employee id: " + id + " does not exist to delete.");
        }
        try (Statement stmt = con.createStatement()) {
    ...
    // Find an model.Employee record using this ID
    ...
    // Return an array of all of the model.Employee records
    ...
    public Employee[] getAllEmployees() throws DAOException {
        try (Statement stmt = con.createStatement()) {
            ...
            // Iterate through the results and create model.Employee objects
            while (rs.next()) {
